        ...
        <div className="bg-white rounded-xl border border-gray-100 overflow-hidden shadow-sm">
          <div className="flex flex-col items-center justify-center py-16 px-4 text-center">
            ...
            <p className="text-sm text-gray-500 max-w-sm">
              There are currently no telemedicine requests matching your search.
            </p>
          </div>
        </div>
      ) : (
              ...
              {req.status === 'Approved' && (
                <div className="mt-auto pt-4 border-t border-gray-100">
                  ...
                  <a 
                    ...
                    className="w-full bg-[#1B3A6B] hover:bg-[#1B3A6B]/90 text-white font-medium py-2 rounded-lg flex items-center justify-center transition-colors text-sm"
                  >
            ...
            <div className="p-6 space-y-4">
              ...
              {actionType === 'Approve' && (
                <div className="space-y-4 mt-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Meeting Link (GMeet/Zoom)</label>
                    <input 
                      type="url" 
                      value={meetingLink}
