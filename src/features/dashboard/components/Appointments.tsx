    ...
    <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
      ...
      <div className="bg-white rounded-xl border border-gray-100 overflow-hidden" style={{ boxShadow: '0 2px 12px rgba(0,0,0,0.06)' }}>
        <div className="flex flex-col items-center justify-center py-16 px-4 text-center">
          ...
          <h3 className="text-lg font-bold text-gray-900 mb-2">No Appointment Requests</h3>
          <p className="text-sm text-gray-500 max-w-sm mb-6">
            There are currently no pending appointment requests from patients. New requests will appear here for you to review and schedule.
          </p>
        </div>
      </div>
    </div>
