...
const SUPPLIES_LIST = [
  { no: 1, name: 'Adhesive steristrips packs 1/2"x4"', beg: '', consumed: Array(31).fill(0), total: 0, end: '' },
  { no: 2, name: 'Absorbent cotton in balls/pack', beg: '', consumed: Array(31).fill(0), total: 0, end: '' },
  { no: 3, name: 'Arm sling orthopedic small', beg: '', consumed: Array(31).fill(0), total: 0, end: '' },
  { no: 4, name: 'Arm sling orthopedic medium', beg: '', consumed: Array(31).fill(0), total: 0, end: '' },
  { no: 5, name: 'Arm sling orthopedic large', beg: '', consumed: Array(31).fill(0), total: 0, end: '' },
  { no: 6, name: 'Arm sling orthopedic x-large', beg: '', consumed: Array(31).fill(0), total: 0, end: '' },
  { no: 7, name: 'Band-Aid 50 strips/box', beg: '', consumed: Array(31).fill(0), total: 0, end: '' },
  { no: 8, name: 'Betadine 10% solution 120mL', beg: '', consumed: Array(31).fill(0), total: 0, end: '' },
  { no: 9, name: 'Betadine gargle 1% oral antiseptic', beg: '', consumed: Array(31).fill(0), total: 0, end: '' },
  { no: 10, name: 'Bactidol gargle 0.1% solution', beg: '', consumed: Array(31).fill(0), total: 0, end: '' },
  { no: 11, name: 'Disposable syringe with needle 3mL', beg: '', consumed: Array(31).fill(0), total: 0, end: '' },
  { no: 12, name: 'Disposable syringe with needle 5mL', beg: '', consumed: Array(31).fill(0), total: 0, end: '' },
  { no: 13, name: 'Disposable syringe with needle 1mL', beg: '', consumed: Array(31).fill(0), total: 0, end: '' },
  { no: 14, name: 'Efficascent oil ES 100mL', beg: '', consumed: Array(31).fill(0), total: 0, end: '' },
  { no: 15, name: 'Efficascent oil regular 100mL', beg: '', consumed: Array(31).fill(0), total: 0, end: '' },
  { no: 16, name: 'Elasctic bandage 2"', beg: '', consumed: Array(31).fill(0), total: 0, end: '' },
  { no: 17, name: 'Elasctic bandage 3"', beg: '', consumed: Array(31).fill(0), total: 0, end: '' },
  { no: 18, name: 'Elasctic bandage 4"', beg: '', consumed: Array(31).fill(0), total: 0, end: '' },
  { no: 19, name: 'Individually packed OS 2x2', beg: '', consumed: Array(31).fill(0), total: 0, end: '' },
  { no: 20, name: 'Individually packed OS 4x4', beg: '', consumed: Array(31).fill(0), total: 0, end: '' },
  { no: 21, name: 'Micropore plaster 1 inch', beg: '', consumed: Array(31).fill(0), total: 0, end: '' },
  { no: 22, name: 'Nebulizing kit ADULT', beg: '', consumed: Array(31).fill(0), total: 0, end: '' },
  { no: 23, name: 'Nebulizing kit PEDIA', beg: '', consumed: Array(31).fill(0), total: 0, end: '' },
  { no: 24, name: 'Non-Rebreathing Mask Adult', beg: '', consumed: Array(31).fill(0), total: 0, end: '' },
  { no: 25, name: 'NSS 1L for irrigation', beg: '', consumed: Array(31).fill(0), total: 0, end: '' },
  { no: 26, name: 'Omega pain killer', beg: '', consumed: Array(31).fill(0), total: 0, end: '' },
  { no: 27, name: 'Oxygen cannula/mask ADULT', beg: '', consumed: Array(31).fill(0), total: 0, end: '' },
  { no: 28, name: 'Oxygen cannula PEDIA', beg: '', consumed: Array(31).fill(0), total: 0, end: '' },
  { no: 29, name: 'Salonpas 10pcs/pack x2', beg: '', consumed: Array(31).fill(0), total: 0, end: '' },
  { no: 30, name: 'Tongue depressors', beg: '', consumed: Array(31).fill(0), total: 0, end: '' },
  { no: 31, name: 'ALCOHOL GREENCROSS', beg: '', consumed: Array(31).fill(0), total: 0, end: '' },
  { no: 32, name: 'KN95 MASK 50 PCS/BOX', beg: '', consumed: Array(31).fill(0), total: 0, end: '' },
];

// Medicines Inventory matching exact May-26 Excel spreadsheet screenshot
const MEDICINE_INVENTORY_TEMPLATE = [
  { no: 1, name: 'Allerta 10mg tab', beg: '', c: Array(31).fill(0), total: 0, end: '', status: '' },
  { no: 2, name: 'Allerkid 60mL bottle', beg: '', c: Array(31).fill(0), total: 0, end: '', status: '' },
  { no: 3, name: 'Alnix 10mg tab', beg: '', c: Array(31).fill(0), total: 0, end: '', status: '' },
  { no: 4, name: 'Aspilets-EC 80mg tab', beg: '', c: Array(31).fill(0), total: 0, end: '', status: '' },
  { no: 5, name: 'Benadryl 25mg', beg: '', c: Array(31).fill(0), total: 0, end: '', status: '' },
  { no: 6, name: 'Benadryl 50mg', beg: '', c: Array(31).fill(0), total: 0, end: '', status: '' },
  { no: 7, name: 'Benadryl 60mL bottle', beg: '', c: Array(31).fill(0), total: 0, end: '', status: '' },
  { no: 8, name: 'Bioflu tab', beg: '', c: Array(31).fill(0), total: 0, end: '', status: '' },
  { no: 9, name: 'Biogesic 500mg tab', beg: '', c: Array(31).fill(0), total: 0, end: '', status: '' },
  { no: 10, name: 'Budecort respules 250mcg/mL', beg: '', c: Array(31).fill(0), total: 0, end: '', status: '' },
  { no: 11, name: 'Buscopan 10mg tab', beg: '', c: Array(31).fill(0), total: 0, end: '', status: '' },
  { no: 12, name: 'Buscopan Plus', beg: '', c: Array(31).fill(0), total: 0, end: '', status: '' },
  { no: 13, name: 'Calmoseptine ointment', beg: '', c: Array(31).fill(0), total: 0, end: '', status: '' },
  { no: 14, name: 'Catapres 75mcg', beg: '', c: Array(31).fill(0), total: 0, end: '', status: '' },
  { no: 15, name: 'Celecoxib 200mg capsule', beg: '', c: Array(31).fill(0), total: 0, end: '', status: '' },
  { no: 16, name: 'Dolcet 37.5mg/325mg tab', beg: '', c: Array(31).fill(0), total: 0, end: '', status: '' },
  { no: 17, name: 'Dolfenal 500mg tab', beg: '', c: Array(31).fill(0), total: 0, end: '', status: '' },
  { no: 18, name: 'Duavent nebules', beg: '', c: Array(31).fill(0), total: 0, end: '', status: '' },
  { no: 19, name: 'Erceflora Niblet', beg: '', c: Array(31).fill(0), total: 0, end: '', status: '' },
  { no: 20, name: 'Erythromycin ointment tubes', beg: '', c: Array(31).fill(0), total: 0, end: '', status: '' },
  { no: 21, name: 'Flotera chewable', beg: '', c: Array(31).fill(0), total: 0, end: '', status: '' },
  { no: 22, name: 'Gaviscon sachet', beg: '', c: Array(31).fill(0), total: 0, end: '', status: '' },
  { no: 23, name: 'Gaviscon tablet', beg: '', c: Array(31).fill(0), total: 0, end: '', status: 'NO STOCK' },
  { no: 24, name: 'Hidrasec 30mg granules', beg: '', c: Array(31).fill(0), total: 0, end: '', status: '' },
  { no: 25, name: 'Hydrite sachet', beg: '', c: Array(31).fill(0), total: 0, end: '', status: '' },
  { no: 26, name: 'Hypromellose 3mg/mL drops', beg: '', c: Array(31).fill(0), total: 0, end: '', status: '' },
  { no: 27, name: 'Imodium 2mg cap', beg: '', c: Array(31).fill(0), total: 0, end: '', status: '' },
  { no: 28, name: 'Isordil SL 5mg tab', beg: '', c: Array(31).fill(0), total: 0, end: '', status: 'NO STOCK' },
  { no: 29, name: 'Kramil-S chewable pink', beg: '', c: Array(31).fill(0), total: 0, end: '', status: '' },
  { no: 30, name: 'Kramil-S ADVANCE', beg: '', c: Array(31).fill(0), total: 0, end: '', status: '' },
  { no: 31, name: 'Motilium 10mg', beg: '', c: Array(31).fill(0), total: 0, end: '', status: '' },
  { no: 32, name: 'Nafarin A', beg: '', c: Array(31).fill(0), total: 0, end: '', status: '' },
  { no: 33, name: 'Norvasc 10mg tab', beg: '', c: Array(31).fill(0), total: 0, end: '', status: '' },
  { no: 34, name: 'Omeprazole 20mg cap', beg: '', c: Array(31).fill(0), total: 0, end: '', status: '' },
  { no: 35, name: 'Omeprazole 40mg cap', beg: '', c: Array(31).fill(0), total: 0, end: '', status: '' },
  { no: 36, name: 'Panto Plus cap', beg: '', c: Array(31).fill(0), total: 0, end: '', status: '' },
  { no: 37, name: 'Paracetamol syrup', beg: '', c: Array(31).fill(0), total: 0, end: '', status: '' },
  { no: 38, name: 'Plavix 75mg tab', beg: '', c: Array(31).fill(0), total: 0, end: '', status: '' },
  { no: 39, name: 'Ranitidine 150mg tab', beg: '', c: Array(31).fill(0), total: 0, end: '', status: '' },
  { no: 40, name: 'Serc 16mg cap', beg: '', c: Array(31).fill(0), total: 0, end: '', status: '' },
  { no: 41, name: 'Sinupret tab', beg: '', c: Array(31).fill(0), total: 0, end: '', status: '' },
  { no: 42, name: 'Strepsils lozenges (8xpack)', beg: '', c: Array(31).fill(0), total: 0, end: '', status: '' },
  { no: 43, name: 'Ventolin nebules', beg: '', c: Array(31).fill(0), total: 0, end: '', status: '' }
];
...
export function Reports({ patients, consultations, medicines, beds, medicalCerts, purchaseRequests }: ReportsProps) {
  ...
  const renderConsumptionCells = (cArray: number[]) => {
    ...
    const intervals = [
      { start: 0, end: '' }, { start: 5, end: '' }, { start: 10, end: '' }, 
      { start: 15, end: '' }, { start: 20, end: '' }, { start: 25, end: '' }
    ];
